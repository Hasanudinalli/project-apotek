<nav class="main-header navbar navbar-expand navbar-dark navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="https://wa.me/6289662747512" class="nav-link">Contact</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          ...
          <span class="badge badge-danger navbar-badge">1000</span>
        </a>
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm">Bagus Website nya</p>
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm">Sini Belajar Online</p>
                <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> Baru saja</p>
              </div>
            </div>
            <!-- Message End -->
